...
class EvolutionApiClient:
    ...
    def _put(self, url: str, payload: Dict[str, Any]) -> httpx.Response:
        return self._request("PUT", url, payload=payload)

    def _delete(self, url: str, params: Optional[Dict[str, Any]] = None) -> httpx.Response:
    ...
    def send_ptv(self, *, number: str, ptv: str, delay: int = 0) -> httpx.Response:
    ...
    def restart_instance(self, instance_name: Optional[str] = None) -> httpx.Response:
        """Restart an instance."""
        target_instance = instance_name or self.instance
        url = f"{self.base}/instance/restart/{target_instance}"
        return self._put(url, {})

    def set_presence(self, *, presence: str) -> httpx.Response:
        """Set instance presence (available, unavailable)."""
        url = self._endpoint("/instance/setPresence")
        payload = {"presence": presence}
        return self._post(url, payload)

    def get_instance_status(self, instance_name: Optional[str] = None) -> httpx.Response:
    ...
    def set_proxy(self, *, proxy_url: str, enabled: bool = True) -> httpx.Response:
        """Set proxy for the instance."""
        url = self._endpoint("/proxy/set")
        payload = {"enabled": enabled, "proxy": proxy_url}
        return self._post(url, payload)

    def find_proxy(self) -> httpx.Response:
    ...
    def set_settings(self, *, settings: Dict[str, Any]) -> httpx.Response:
        """Set instance settings."""
        url = self._endpoint("/settings/set")
        return self._post(url, settings)

    def find_settings(self) -> httpx.Response:
    ...
    def check_wa_number(self, *, numbers: List[str]) -> httpx.Response:
        """Check if numbers are registered on WhatsApp."""
        url = self._endpoint("/chat/whatsappNumbers")
        payload = {"numbers": numbers}
        return self._post(url, payload)

    def chat_archive(self, *, number: str, archive: bool = True) -> httpx.Response:
        """Archive or unarchive a chat."""
        url = self._endpoint("/chat/archiveChat")
        payload = {"number": number, "archive": archive}
        return self._post(url, payload)

    def chat_mark_read(self, *, number: str, read: bool = True) -> httpx.Response:
    ...
    def delete_chat(self, *, number: str) -> httpx.Response:
        """Delete a chat."""
        url = self._endpoint("/chat/deleteMessage")
        payload = {"number": number}
        return self._post(url, payload)

    def delete_message_for_everyone(self, *, message_id: str, remote_jid: str, from_me: bool = True) -> httpx.Response:
        """Delete a message for everyone in the chat (Baileys only)."""
        url = self._endpoint("/chat/deleteMessageForEveryone")
        return self._delete(url, params={"id": message_id, "remoteJid": remote_jid, "fromMe": str(from_me).lower()})

    def fetch_profile_picture_url(self, *, number: str) -> httpx.Response:
        """Fetch contact/group profile picture URL."""
        url = self._endpoint("/chat/fetchProfilePictureUrl")
        payload = {"number": number}
        return self._post(url, payload)

    def get_base64_media(self, *, message_id: str) -> httpx.Response:
        """Get media in base64 from a message."""
        url = self._endpoint("/chat/getBase64FromMediaMessage")
        payload = {"key": {"id": message_id}}
        return self._post(url, payload)

    def update_message(self, *, number: str, message_id: str, text: str) -> httpx.Response:
    ...
    def set_chat_presence(self, *, number: str, presence: str, delay: int = 0) -> httpx.Response:
    ...
    def block_contact(self, *, number: str, status: str) -> httpx.Response:
    ...
    def label_find(self) -> httpx.Response:
        """Find all labels."""
        url = self._endpoint("/label/findLabels")
        return self._get(url)

    def label_handle(self, *, number: str, label_id: str, action: str) -> httpx.Response:
    ...
    def profile_fetch_business(self, *, number: str) -> httpx.Response:
        """Fetch business profile."""
        url = self._endpoint("/chat/fetchBusinessProfile")
        payload = {"number": number}
        return self._post(url, payload)

    def profile_fetch(self, *, number: str) -> httpx.Response:
    ...
    def profile_update_picture(self, *, picture: str) -> httpx.Response:
        """Update profile picture. picture: URL or base64."""
        url = self._endpoint("/profile/updateProfilePicture")
        payload = {"picture": picture}
        return self._post(url, payload)

    def profile_remove_picture(self) -> httpx.Response:
        """Remove profile picture."""
        url = self._endpoint("/profile/removeProfilePicture")
        return self._delete(url)

    def profile_fetch_privacy(self) -> httpx.Response:
        """Fetch privacy settings."""
        url = self._endpoint("/profile/fetchPrivacySettings")
        return self._get(url)

    def profile_update_privacy(self, *, settings: Dict[str, str]) -> httpx.Response:
    ...
    def group_update_picture(self, *, group_jid: str, image_url: str) -> httpx.Response:
        """Update group profile picture."""
        url = self._endpoint("/group/updateProfilePicture")
        payload = {"id": group_jid, "image": image_url}
        return self._post(url, payload)

    def group_update_subject(self, *, group_jid: str, subject: str) -> httpx.Response:
        """Update group subject."""
        url = self._endpoint("/group/updateSubject")
        payload = {"id": group_jid, "subject": subject}
        return self._post(url, payload)

    def group_update_description(self, *, group_jid: str, description: str) -> httpx.Response:
        """Update group description."""
        url = self._endpoint("/group/updateDescription")
        payload = {"id": group_jid, "description": description}
        return self._post(url, payload)

    def group_fetch_all(self) -> httpx.Response:
        """Fetch all groups."""
        url = self._endpoint("/group/fetchAllGroups")
        return self._get(url)

    def group_find_infos(self, *, group_jid: str) -> httpx.Response:
        """Fetch detailed group info by JID."""
        url = self._endpoint("/group/findGroupInfos")
        return self._get(url, params={"groupJid": group_jid})

    def group_find_by_invite_code(self, *, invite_code: str) -> httpx.Response:
        """Find a group by its invite code (Baileys only)."""
        url = self._endpoint("/group/inviteInfo")
        return self._get(url, params={"inviteCode": invite_code})

    def group_get_participants(self, *, group_jid: str) -> httpx.Response:
        """Get participants of a group."""
        url = self._endpoint("/group/participants")
        return self._get(url, params={"groupJid": group_jid})

    def group_get_invite_code(self, *, group_jid: str) -> httpx.Response:
        """Get the invite code for a group."""
        url = self._endpoint("/group/inviteCode")
        return self._get(url, params={"groupJid": group_jid})

    def group_revoke_invite(self, *, group_jid: str) -> httpx.Response:
        """Revoke a group's invite link."""
        url = self._endpoint("/group/revokeInviteCode")
        payload = {"id": group_jid}
        return self._post(url, payload)

    def group_send_invite(self, *, group_jid: str, numbers: List[str], description: Optional[str] = None) -> httpx.Response:
    ...
    def group_update_settings(self, *, group_jid: str, action: str) -> httpx.Response:
    ...
    def group_toggle_ephemeral(self, *, group_jid: str, expiration: int) -> httpx.Response:
    ...
    def group_leave(self, *, group_jid: str) -> httpx.Response:
        """Leave a group."""
        url = self._endpoint("/group/leaveGroup")
        payload = {"id": group_jid}
        return self._delete(url, params={"groupJid": group_jid})

    # ── Integrations: Events ──────────────────────────────────────────

    def set_webhook(self, *, url: str, events: Optional[List[str]] = None, enabled: bool = True, **kwargs) -> httpx.Response:
    ...
    def find_webhook(self) -> httpx.Response:
        """Get webhook configuration."""
        url = self._endpoint("/webhook/find")
        return self._get(url)

    def set_websocket(self, *, enabled: bool = True, events: Optional[List[str]] = None) -> httpx.Response:
    ...
    def find_websocket(self) -> httpx.Response:
        """Get websocket configuration."""
        url = self._endpoint("/websocket/find")
        return self._get(url)

    def set_rabbitmq(self, *, enabled: bool = True, events: Optional[List[str]] = None) -> httpx.Response:
    ...
    def find_rabbitmq(self) -> httpx.Response:
        """Get RabbitMQ configuration."""
        url = self._endpoint("/rabbitmq/find")
        return self._get(url)

    def set_sqs(self, *, enabled: bool = True, events: Optional[List[str]] = None) -> httpx.Response:
    ...
    def find_sqs(self) -> httpx.Response:
        """Get SQS configuration."""
        url = self._endpoint("/sqs/find")
        return self._get(url)

    def set_nats(self, *, enabled: bool = True, events: Optional[List[str]] = None) -> httpx.Response:
    ...
    def find_nats(self) -> httpx.Response:
        """Get NATS configuration."""
        url = self._endpoint("/nats/find")
        return self._get(url)

    def set_pusher(self, *, enabled: bool = True, events: Optional[List[str]] = None, **kwargs) -> httpx.Response:
    ...
    def find_pusher(self) -> httpx.Response:
